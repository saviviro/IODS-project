...
__Caption:__ Biplot presenting the first two principal components obtained from applying principal component analysis based on singular value decomposition on non-standardized human data. The arrows represent the original variables.
...
__Caption:__ Biplot presenting the first two principal components obtained from applying principal component analysis based on singular value decomposition on standardized human data. The arrows represent the original variables.
